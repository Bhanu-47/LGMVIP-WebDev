...
<body>
    <a href="index.html"><img src="./images/logo6.png" alt="" style="float: left;width: 110px;height: 90px;"></a>
    <div class="title">
        <h5 class="heading" style="text-align: center; color:white">Student Result Management System</h5>
    </div>
    <div class="main">
        <div class="login">
